          ...
          <div class="flex h-16 justify-between">
            ...
            <div class="hidden sm:ml-6 sm:flex sm:items-center">
              ...
              >
                <div>
                  <MenuButton
                    class="relative flex rounded-full bg-white text-sm focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2"
                  >
...
const user = computed(() => ({
  ...
  imageUrl: loggedInUser.value?.profilePicture,
}));

const navigation = [
  { name: 'Phòng game', href: '/game', current: () => route.name === 'rooms' },
  {
    name: 'Lịch sử',
    href: '/history',
    current: () => route.name === 'history',
  },
];
